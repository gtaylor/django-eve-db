...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MapLandmark.importance'
        db.delete_column(u'eve_db_maplandmark', 'importance')

        # Deleting field 'MapLandmark.radius'
        db.delete_column(u'eve_db_maplandmark', 'radius')


    def backwards(self, orm):
        # Adding field 'MapLandmark.importance'
        db.add_column(u'eve_db_maplandmark', 'importance',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MapLandmark.radius'
        db.add_column(u'eve_db_maplandmark', 'radius',
    ...
    models = {
        ...
        'eve_db.ramtyperequirement': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'recycle': ('django.db.models.fields.BooleanField', [], {}),
