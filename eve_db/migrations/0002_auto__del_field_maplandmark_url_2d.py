...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MapLandmark.url_2d'
        db.delete_column('eve_db_maplandmark', 'url_2d')


    def backwards(self, orm):
        
        # Adding field 'MapLandmark.url_2d'
        db.add_column('eve_db_maplandmark', 'url_2d', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
