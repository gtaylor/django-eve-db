...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CrpNPCCorporation.station_system_count'
        db.alter_column('eve_db_crpnpccorporation', 'station_system_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CrpNPCCorporation.station_count'
        db.alter_column('eve_db_crpnpccorporation', 'station_count', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'CrpNPCCorporation.station_system_count'
        db.alter_column('eve_db_crpnpccorporation', 'station_system_count', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'CrpNPCCorporation.station_count'
        db.alter_column('eve_db_crpnpccorporation', 'station_count', self.gf('django.db.models.fields.IntegerField')())
