...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChrFaction.icon'
        db.delete_column('eve_db_chrfaction', 'icon')

        # Adding field 'ChrFaction.icon_id'
        db.add_column('eve_db_chrfaction', 'icon_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DgmEffect.icon'
        db.delete_column('eve_db_dgmeffect', 'icon')

        # Adding field 'DgmEffect.icon_id'
        db.add_column('eve_db_dgmeffect', 'icon_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'MapLandmark.icon'
        db.delete_column('eve_db_maplandmark', 'icon')

        # Adding field 'MapLandmark.icon_id'
        db.add_column('eve_db_maplandmark', 'icon_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CrpNPCCorporation.icon'
        db.delete_column('eve_db_crpnpccorporation', 'icon')

        # Adding field 'CrpNPCCorporation.icon_id'
        db.add_column('eve_db_crpnpccorporation', 'icon_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ChrRace.icon'
        db.delete_column('eve_db_chrrace', 'icon')

        # Adding field 'ChrRace.icon_id'
        db.add_column('eve_db_chrrace', 'icon_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InvMetaGroup.icon'
        db.delete_column('eve_db_invmetagroup', 'icon')

        # Adding field 'InvMetaGroup.icon_id'
        db.add_column('eve_db_invmetagroup', 'icon_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InvCategory.icon'
        db.delete_column('eve_db_invcategory', 'icon')

        # Adding field 'InvCategory.icon_id'
        db.add_column('eve_db_invcategory', 'icon_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InvGroup.icon'
        db.delete_column('eve_db_invgroup', 'icon')

        # Adding field 'InvGroup.icon_id'
        db.add_column('eve_db_invgroup', 'icon_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ChrAncestry.icon'
        db.delete_column('eve_db_chrancestry', 'icon')

        # Adding field 'ChrAncestry.icon_id'
        db.add_column('eve_db_chrancestry', 'icon_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InvMarketGroup.icon'
        db.delete_column('eve_db_invmarketgroup', 'icon')

        # Adding field 'InvMarketGroup.icon_id'
        db.add_column('eve_db_invmarketgroup', 'icon_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ChrAttribute.icon'
        db.delete_column('eve_db_chrattribute', 'icon')

        # Adding field 'ChrAttribute.icon_id'
        db.add_column('eve_db_chrattribute', 'icon_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ChrBloodline.icon'
        db.delete_column('eve_db_chrbloodline', 'icon')

        # Adding field 'ChrBloodline.icon_id'
        db.add_column('eve_db_chrbloodline', 'icon_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DgmAttributeType.icon'
        db.delete_column('eve_db_dgmattributetype', 'icon')

        # Adding field 'DgmAttributeType.icon_id'
        db.add_column('eve_db_dgmattributetype', 'icon_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ChrFaction.icon'
        db.add_column('eve_db_chrfaction', 'icon',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ChrFaction.icon_id'
        db.delete_column('eve_db_chrfaction', 'icon_id')

        # Adding field 'DgmEffect.icon'
        db.add_column('eve_db_dgmeffect', 'icon',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DgmEffect.icon_id'
        db.delete_column('eve_db_dgmeffect', 'icon_id')

        # Adding field 'MapLandmark.icon'
        db.add_column('eve_db_maplandmark', 'icon',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'MapLandmark.icon_id'
        db.delete_column('eve_db_maplandmark', 'icon_id')

        # Adding field 'CrpNPCCorporation.icon'
        db.add_column('eve_db_crpnpccorporation', 'icon',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CrpNPCCorporation.icon_id'
        db.delete_column('eve_db_crpnpccorporation', 'icon_id')

        # Adding field 'ChrRace.icon'
        db.add_column('eve_db_chrrace', 'icon',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ChrRace.icon_id'
        db.delete_column('eve_db_chrrace', 'icon_id')

        # Adding field 'InvMetaGroup.icon'
        db.add_column('eve_db_invmetagroup', 'icon',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InvMetaGroup.icon_id'
        db.delete_column('eve_db_invmetagroup', 'icon_id')

        # Adding field 'InvCategory.icon'
        db.add_column('eve_db_invcategory', 'icon',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InvCategory.icon_id'
        db.delete_column('eve_db_invcategory', 'icon_id')

        # Adding field 'InvGroup.icon'
        db.add_column('eve_db_invgroup', 'icon',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InvGroup.icon_id'
        db.delete_column('eve_db_invgroup', 'icon_id')

        # Adding field 'ChrAncestry.icon'
        db.add_column('eve_db_chrancestry', 'icon',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ChrAncestry.icon_id'
        db.delete_column('eve_db_chrancestry', 'icon_id')

        # Adding field 'InvMarketGroup.icon'
        db.add_column('eve_db_invmarketgroup', 'icon',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InvMarketGroup.icon_id'
        db.delete_column('eve_db_invmarketgroup', 'icon_id')

        # Adding field 'ChrAttribute.icon'
        db.add_column('eve_db_chrattribute', 'icon',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ChrAttribute.icon_id'
        db.delete_column('eve_db_chrattribute', 'icon_id')

        # Adding field 'ChrBloodline.icon'
        db.add_column('eve_db_chrbloodline', 'icon',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ChrBloodline.icon_id'
        db.delete_column('eve_db_chrbloodline', 'icon_id')

        # Adding field 'DgmAttributeType.icon'
        db.add_column('eve_db_dgmattributetype', 'icon',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DgmAttributeType.icon_id'
        db.delete_column('eve_db_dgmattributetype', 'icon_id')
