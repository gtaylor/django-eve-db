...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DgmAttributeType.defaultvalue'
        db.delete_column('eve_db_dgmattributetype', 'defaultvalue')

        # Adding field 'DgmAttributeType.default_value'
        db.add_column('eve_db_dgmattributetype', 'default_value', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'DgmAttributeType.defaultvalue'
        db.add_column('eve_db_dgmattributetype', 'defaultvalue', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'DgmAttributeType.default_value'
        db.delete_column('eve_db_dgmattributetype', 'default_value')
