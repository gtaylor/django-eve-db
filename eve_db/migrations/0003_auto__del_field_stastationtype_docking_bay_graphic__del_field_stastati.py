...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StaStationType.docking_bay_graphic'
        db.delete_column('eve_db_stastationtype', 'docking_bay_graphic_id')

        # Deleting field 'StaStationType.hangar_graphic'
        db.delete_column('eve_db_stastationtype', 'hangar_graphic_id')


    def backwards(self, orm):
        
        # Adding field 'StaStationType.docking_bay_graphic'
        db.add_column('eve_db_stastationtype', 'docking_bay_graphic', self.gf('django.db.models.fields.related.ForeignKey')(related_name='docking_bay_graphic', null=True, to=orm['eve_db.EveGraphic'], blank=True), keep_default=False)

        # Adding field 'StaStationType.hangar_graphic'
        db.add_column('eve_db_stastationtype', 'hangar_graphic', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hangar_graphic', null=True, to=orm['eve_db.EveGraphic'], blank=True), keep_default=False)
