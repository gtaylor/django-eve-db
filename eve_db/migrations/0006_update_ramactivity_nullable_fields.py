...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RamActivity.icon_filename'
        db.alter_column('eve_db_ramactivity', 'icon_filename', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))


    def backwards(self, orm):
        
        # Changing field 'RamActivity.icon_filename'
        db.alter_column('eve_db_ramactivity', 'icon_filename', self.gf('django.db.models.fields.CharField')(max_length=50))
