...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MapSolarSystem.z_max'
        db.add_column('eve_db_mapsolarsystem', 'z_max', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MapSolarSystem.z_max'
        db.delete_column('eve_db_mapsolarsystem', 'z_max')
