...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'ChrFaction.icon' to match new field type.
        db.rename_column('eve_db_chrfaction', 'icon_id', 'icon')
        ...
        db.rename_column('eve_db_dgmeffect', 'icon_id', 'icon')
        ...
        db.rename_column('eve_db_maplandmark', 'icon_id', 'icon')
        ...
        db.rename_column('eve_db_crpnpccorporation', 'icon_id', 'icon')
        ...
        db.rename_column('eve_db_chrrace', 'icon_id', 'icon')
        ...
        # Renaming column for 'InvMetaGroup.icon' to match new field type.
        db.rename_column('eve_db_invmetagroup', 'icon_id', 'icon')
        ...
        db.rename_column('eve_db_invcategory', 'icon_id', 'icon')
        ...
        db.rename_column('eve_db_invgroup', 'icon_id', 'icon')
        ...
        db.rename_column('eve_db_chrancestry', 'icon_id', 'icon')
        ...
        db.alter_column('eve_db_invmarketgroup', 'description', self.gf('django.db.models.fields.CharField')(max_length=300012, null=True))

        # Renaming column for 'InvMarketGroup.icon' to match new field type.
        db.rename_column('eve_db_invmarketgroup', 'icon_id', 'icon')
        ...
        db.rename_column('eve_db_chrattribute', 'icon_id', 'icon')
        ...
        db.rename_column('eve_db_chrbloodline', 'icon_id', 'icon')
        ...
        db.rename_column('eve_db_dgmattributetype', 'icon_id', 'icon')
    ...
    def backwards(self, orm):
        ...
        # Renaming column for 'ChrFaction.icon' to match new field type.
        db.rename_column('eve_db_chrfaction', 'icon', 'icon_id')
        # Changing field 'ChrFaction.icon'
        db.alter_column('eve_db_chrfaction', 'icon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.EveIcon'], null=True))

        # Renaming column for 'DgmEffect.icon' to match new field type.
        db.rename_column('eve_db_dgmeffect', 'icon', 'icon_id')
        # Changing field 'DgmEffect.icon'
        db.alter_column('eve_db_dgmeffect', 'icon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.EveIcon'], null=True))

        # Renaming column for 'MapLandmark.icon' to match new field type.
        db.rename_column('eve_db_maplandmark', 'icon', 'icon_id')
        # Changing field 'MapLandmark.icon'
        db.alter_column('eve_db_maplandmark', 'icon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.EveIcon'], null=True))

        # Renaming column for 'CrpNPCCorporation.icon' to match new field type.
        db.rename_column('eve_db_crpnpccorporation', 'icon', 'icon_id')
        # Changing field 'CrpNPCCorporation.icon'
        db.alter_column('eve_db_crpnpccorporation', 'icon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.EveIcon'], null=True))

        # Renaming column for 'ChrRace.icon' to match new field type.
        db.rename_column('eve_db_chrrace', 'icon', 'icon_id')
        # Changing field 'ChrRace.icon'
        db.alter_column('eve_db_chrrace', 'icon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.EveIcon'], null=True))
        # Adding field 'InvType.icon'
        db.add_column('eve_db_invtype', 'icon',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.EveIcon'], null=True, blank=True),
                      keep_default=False)


        # Renaming column for 'InvMetaGroup.icon' to match new field type.
        db.rename_column('eve_db_invmetagroup', 'icon', 'icon_id')
        # Changing field 'InvMetaGroup.icon'
        db.alter_column('eve_db_invmetagroup', 'icon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.EveIcon'], null=True))

        # Renaming column for 'InvCategory.icon' to match new field type.
        db.rename_column('eve_db_invcategory', 'icon', 'icon_id')
        # Changing field 'InvCategory.icon'
        db.alter_column('eve_db_invcategory', 'icon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.EveIcon'], null=True))

        # Renaming column for 'InvGroup.icon' to match new field type.
        db.rename_column('eve_db_invgroup', 'icon', 'icon_id')
        # Changing field 'InvGroup.icon'
        db.alter_column('eve_db_invgroup', 'icon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.EveIcon'], null=True))

        # Renaming column for 'ChrAncestry.icon' to match new field type.
        db.rename_column('eve_db_chrancestry', 'icon', 'icon_id')
        # Changing field 'ChrAncestry.icon'
        db.alter_column('eve_db_chrancestry', 'icon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.EveIcon'], null=True))

        # Changing field 'InvMarketGroup.description'
        db.alter_column('eve_db_invmarketgroup', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Renaming column for 'InvMarketGroup.icon' to match new field type.
        db.rename_column('eve_db_invmarketgroup', 'icon', 'icon_id')
        # Changing field 'InvMarketGroup.icon'
        db.alter_column('eve_db_invmarketgroup', 'icon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.EveIcon'], null=True))

        # Renaming column for 'ChrAttribute.icon' to match new field type.
        db.rename_column('eve_db_chrattribute', 'icon', 'icon_id')
        # Changing field 'ChrAttribute.icon'
        db.alter_column('eve_db_chrattribute', 'icon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.EveIcon'], null=True))

        # Renaming column for 'ChrBloodline.icon' to match new field type.
        db.rename_column('eve_db_chrbloodline', 'icon', 'icon_id')
        # Changing field 'ChrBloodline.icon'
        db.alter_column('eve_db_chrbloodline', 'icon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.EveIcon'], null=True))

        # Renaming column for 'DgmAttributeType.icon' to match new field type.
        db.rename_column('eve_db_dgmattributetype', 'icon', 'icon_id')
        # Changing field 'DgmAttributeType.icon'
        db.alter_column('eve_db_dgmattributetype', 'icon_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eve_db.EveIcon'], null=True))
