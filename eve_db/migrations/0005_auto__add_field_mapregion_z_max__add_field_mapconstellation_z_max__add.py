...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MapRegion.z_max'
        db.add_column('eve_db_mapregion', 'z_max', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MapConstellation.z_max'
        db.add_column('eve_db_mapconstellation', 'z_max', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MapUniverse.z_max'
        db.add_column('eve_db_mapuniverse', 'z_max', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MapRegion.z_max'
        db.delete_column('eve_db_mapregion', 'z_max')

        # Deleting field 'MapConstellation.z_max'
        db.delete_column('eve_db_mapconstellation', 'z_max')

        # Deleting field 'MapUniverse.z_max'
        db.delete_column('eve_db_mapuniverse', 'z_max')
